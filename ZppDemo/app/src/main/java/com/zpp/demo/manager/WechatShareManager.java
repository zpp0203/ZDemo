...
public class WechatShareManager {
    ...
    private void sharePicture(ShareContent shareContent, int shareType) {
        ...
        bitmap.recycle();
        msg.thumbData = ImageUtils.bitmap2Bytes(thumbBitmap, Bitmap.CompressFormat.PNG);  //设置缩略图
...
//      BitmapFactory.decodeStream(new URL(video.videoUrl).openStream());
        ...
        msg.thumbData = ImageUtils.bitmap2Bytes(thumbBitmap, Bitmap.CompressFormat.PNG);
