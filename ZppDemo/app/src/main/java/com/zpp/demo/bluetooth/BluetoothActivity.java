...
import com.zpp.demo.bluetooth.adapter.BlueListAdapter;
import com.zpp.demo.bluetooth.bean.BlueDevice;
import com.zpp.demo.bluetooth.task.BlueAcceptTask;
import com.zpp.demo.bluetooth.task.BlueConnectTask;
...
public class BluetoothActivity extends AppCompatActivity implements
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            if (BluetoothUtil.getBlueToothStatus() == true) {
                ck_bluetooth.setChecked(true);
            }
            ck_bluetooth.setOnCheckedChangeListener(this);
            tv_discovery.setOnClickListener(this);
