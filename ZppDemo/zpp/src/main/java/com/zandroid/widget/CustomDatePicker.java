...
public class CustomDatePicker {
    ...
    private WheelView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    private void initView() {
        ...
        hour_pv = (WheelView) datePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (WheelView) datePickerDialog.findViewById(R.id.minute_pv);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new WheelView.onSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new WheelView.onSelectListener() {
            @Override
        ...
        day_pv.setOnSelectListener(new WheelView.onSelectListener() {
            @Override
        ...
        hour_pv.setOnSelectListener(new WheelView.onSelectListener() {
            @Override
        ...
        minute_pv.setOnSelectListener(new WheelView.onSelectListener() {
            @Override
            public void onSelect(String text) {
    ...
    private void monthChange() {
        ...
        //重新设置月份
//        selectedCalender.set(Calendar.MONTH, Integer.parseInt(month.get(0)));
//        month_pv.setData(month);
//        month_pv.setSelected(0);
//        executeAnimator(month_pv);//跳动动画
