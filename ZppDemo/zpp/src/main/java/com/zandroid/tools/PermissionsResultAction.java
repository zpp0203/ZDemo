...
import static com.zandroid.tools.PermissionsManager.DENIED;
import static com.zandroid.tools.PermissionsManager.GRANTED;
import static com.zandroid.tools.PermissionsManager.NOT_FOUND;
...
//            return onResult(permission, GRANTED);
//        } else {
//            return onResult(permission, DENIED);
//        }
//
//    }
    ...
    @SuppressWarnings("WeakerAccess")
    @CallSuper
    protected synchronized final boolean onResult(int requestCode, final @NonNull String permission, int result) {
        final int re=requestCode;
