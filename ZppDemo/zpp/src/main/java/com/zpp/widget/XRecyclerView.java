...
public class XRecyclerView extends RecyclerView {
    ...
    static final int STATE_RELEASE_TO_REFRESH = 1;
    ...
    private DefaultMoreFooter mFootView;
    ...
    private void init() {
        ...
        mFootView = new DefaultMoreFooter(getContext());
    ...
    public DefaultRefreshHeader getRefreshHeaderView(){
        if(mRefreshHeader == null){
            return null;
        }
    ...
    public DefaultMoreFooter getFootView() {
        return mFootView;
    }
    ...
    public void loadMoreComplete() {
        isLoadingData = false;
        if(mFootView!=null)
        mFootView.setState(STATE_COMPLETE);
    }
    ...
    public void setNoMore(boolean noMore){
        ...
        isNoMore = noMore;
        if(noMore){
            mFootView.setState(isNoMore? STATE_NOMORE:STATE_COMPLETE);
        }
    }
    public void refresh() {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (
                    layoutManager.getChildCount() > 0
                            ...
                            && !isNoMore
                            && status < STATE_REFRESHING
                    ){
                isLoadingData = true;
                mFootView.setState(STATE_LOADING);
