...
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName(Application application) {
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) application
    ...
    public static Set<String> getAllBackgroundProcesses(Application application) {
    ...
    public static Set<String> killAllBackgroundProcesses(Application application) {
    ...
    public static boolean killBackgroundProcesses(Application application,@NonNull final String packageName) {
