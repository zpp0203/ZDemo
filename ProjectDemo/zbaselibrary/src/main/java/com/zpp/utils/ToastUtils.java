...
public final class ToastUtils {
    ...
    private static int sYOffset = 100;
     ...
     *
     * @param resourse The text.
     */
    public static void showToast(Context context,int resourse) {
        showToast(context,context.getResources().getString(resourse));
    }
    ...
    public static void showToast(Context context,String text,ToastAttachStateChangeListener changeListener) {
        if(text==null || text.isEmpty()){
            return;
        }
            ...
            public void run() {
                ...
                try{
                    ...
                    if (checkNotification == 1 && context instanceof Activity) {
                        ...
                        ((EToast) sToast).setStateChangeListener(new EToast.ToastAttachStateChangeListener() {
                            @Override
    ...
    private static void showToast(Context context) {
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.N_MR1) {
            try {
                Field field = View.class.getDeclaredField("mActivity");
    ...
    private static void show(){
        ...
        if(sToast instanceof EToast){
            ...
            ((Toast) sToast).show();
            ((Toast) sToast).getView().addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
                @Override
    ...
    private static ToastAttachStateChangeListener stateChangeListener;
